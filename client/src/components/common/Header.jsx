...
const Header = () => {
  ...
  return (
    ...
    bg-clip-text text-transparent drop-shadow-lg"
            ...
            <div className="h-[3px] w-40 mt-2 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full"></div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link
              to="/wishlist"
              className="text-gray-300 hover:text-cyan-400 transition duration-300 hover:scale-110"
            >
              <Heart size={22} />
            </Link>
            ...
            {!isLoggedIn ? (
              ...
              <div className="flex items-center gap-3">
                <Link
                  ...
                  bg-white/10 hover:bg-white/20 transition text-white backdrop-blur-md"
                >
                  <User size={18} />
      ...
      {showMobileMenu && (
        <div className="md:hidden bg-slate-900 border-t border-white/10 px-6 py-4 space-y-3">
          ...
          <Link to="/cart" className="block text-gray-300 hover:text-cyan-400">
            Cart
          </Link>
