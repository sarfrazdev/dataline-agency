  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-cyan-50 text-gray-800">
      <div className="max-w-7xl mx-auto py-10 px-4">
        ...
        {/* Heading */}
        <h1 className="text-4xl font-bold text-center mb-10 bg-gradient-to-r from-teal-500 to-cyan-500 bg-clip-text text-transparent">
          Shop IT Accessories
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <select
            ...
            className="w-full px-4 py-3 rounded-xl bg-white border border-gray-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-400"
          >
        ...
        <div className="mb-10 flex justify-center">
          <input
            ...
            className="w-full md:w-1/2 px-5 py-3 rounded-full border border-gray-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {displayedProducts.map(product => (
            ...
            >
              {/* Image */}
              <div
                className="relative h-60 flex items-center justify-center bg-white cursor-pointer"
