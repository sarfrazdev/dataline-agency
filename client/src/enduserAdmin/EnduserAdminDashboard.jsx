  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `${BASE_URL}${API_PATH.ADMIN_PANEL.ENDUSER_ADMIN}`,
        {
          headers: {
  ...
  return (
    <NavLayout>
      <div className="min-h-screen p-6 bg-[#1e1e1e] text-white">
        <h1 className="text-3xl font-bold mb-6">End User Admin Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          ...
          <div
            ...
            onClick={() => navigate('/enduser-admin/notifications')}
          >
          ...
          <div
            ...
            onClick={() => navigate('/enduser-admin/orders')}
          >
...
export default EnduserAdminDashboard;
