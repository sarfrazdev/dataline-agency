...
// //     // Ensure the endpoint is correct and the function returns a string path
...
// //                     {order.shippingInfo?.addressLine}, {order.shippingInfo?.city},{' '}
...
// //                         {item.product?.brand || 'No Brand'}) — {item.quantity} × ₹
...
// //                         <a
// //                           href={order.billUrl}
// //                           download={`bill-${order._id}.pdf`}
// //                           className="text-green-600 text-xs underline"
// //                         >
// //                           Download
// //                         </a>
// //                         <button
// //                           onClick={() => handleDeleteBill(order._id)}
...
//                   <p className="text-sm">{order.shippingInfo?.fullName}, {order.shippingInfo?.address}, {order.shippingInfo?.city}, {order.shippingInfo?.state} - {order.shippingInfo?.pincode}</p>
//                 </div>
...
//                     {order.items.map((item, idx) => (
//                       <li key={idx}>
//                         {item.product?.name} ({item.product?.brand}) — {item.quantity} × ₹{item.price} = ₹{item.quantity * item.price}
//                       </li>
//                     ))}
//                   </ul>
//                 </div>
